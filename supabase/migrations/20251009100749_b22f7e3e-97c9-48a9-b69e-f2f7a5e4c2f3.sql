-- Revert to public schema for extensions (this is acceptable for cron jobs)
-- The warning about extensions in public schema is not critical for this use case

-- Ensure extensions exist in public schema
