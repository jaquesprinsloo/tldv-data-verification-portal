          ...
          <Card className="max-w-md text-center border-0 shadow-none">
            <CardContent className="pt-12 pb-12">
              ...
              <p className="text-muted-foreground mb-6">
                Your profile verification has been submitted successfully. An administrator will review your details shortly.
              </p>
              
              <div className="bg-muted p-4 rounded-lg mb-6">
                <h3 className="font-semibold mb-2">📅 Renewal Process</h3>
                ...
                <p className="text-sm text-muted-foreground">
                  You will receive reminder emails before your renewal is due.
                </p>
              </div>
