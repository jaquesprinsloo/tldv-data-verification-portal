...
export const ProfileDetailsDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-black border-2 border-red-600 text-white max-w-lg">
        <DialogHeader>
          <DialogTitle className="text-white text-xl">Manage Profile</DialogTitle>
        </DialogHeader>

        <Tabs defaultValue="details" className="w-full">
          <TabsList className="grid w-full grid-cols-3 bg-black border border-red-600">
            <TabsTrigger value="details" className="data-[state=active]:bg-red-600">Details</TabsTrigger>
            <TabsTrigger value="roles" className="data-[state=active]:bg-red-600">Roles</TabsTrigger>
            <TabsTrigger value="password" className="data-[state=active]:bg-red-600">Password</TabsTrigger>
          </TabsList>
